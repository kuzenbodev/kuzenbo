...
const toastRootVariants = tv({
  base: "group/toast-root z-toast-stack border-border bg-popover text-popover-foreground border shadow-lg",
  compoundVariants: [
    {
      anchored: true,

...
export const Default: Story = {
  render: () => (
    <ContextMenu>
      <ContextMenu.Trigger className="flex h-32 w-72 items-center justify-center rounded-md border border-dashed border-border">
    ...
    <div className="flex w-96 flex-col gap-8">
      {sizes.map((size) => (
        <ContextMenu key={size} size={size}>
          <ContextMenu.Trigger className="flex h-16 items-center justify-center rounded-md border border-dashed border-border">
            Table settings ({size})
          </ContextMenu.Trigger>
          <ContextMenu.Content>
            <ContextMenu.Group>

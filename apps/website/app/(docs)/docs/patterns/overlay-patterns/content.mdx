...
order: 6
surface: "guide"
seoTitle: "Overlay Patterns | Kuzenbo Docs"
seoDescription: "How to choose and implement overlay primitives in @kuzenbo/core with accessible focus and layering behavior."
ogImage: "/docs-og/patterns/overlay-patterns"
ogImageAlt: "Overlay pattern guidance"
aliases:
  - "/docs/features/overlay-patterns"
---

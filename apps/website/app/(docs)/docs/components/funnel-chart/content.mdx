...
order: 38
surface: "component"
seoTitle: "Funnel Chart | Kuzenbo Docs"
seoDescription: "Render stage-dropoff funnels in @kuzenbo/charts with optional labels, legend highlighting, and tooltip strategies."
ogImage: "/docs-og/components/funnel-chart"
ogImageAlt: "Funnel Chart documentation"
---
...
```tsx
import { FunnelChart, type CompleteChartSeries } from "@kuzenbo/charts";
```

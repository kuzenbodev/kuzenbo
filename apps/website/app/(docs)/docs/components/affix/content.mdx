...
order: 3
surface: "component"
seoTitle: "Affix | Kuzenbo Docs"
seoDescription: "Use Affix to anchor controls to viewport edges with portal and z-index control."
ogImage: "/docs-og/components/affix"
ogImageAlt: "Affix documentation"
aliases:
  - "/docs/components/layout/affix"
---
...
```tsx
import { Affix, affixVariants } from "@kuzenbo/core";
```

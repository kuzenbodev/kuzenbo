...
- Predictable stacking with the semantic `z-affix` layer token and optional `zIndex` override
...
- `zIndex?: CSSProperties["zIndex"]`
  Defaults to the semantic `z-affix` utility (`--kb-z-affix`).
...
- Override global stacking with CSS variables when needed:

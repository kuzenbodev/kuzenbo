...
seoDescription: "Set up Kuzenbo theme runtime with cookie/localStorage fallbacks and SSR-safe class application."
ogImage: "/docs-og/getting-started/theming"
ogImageAlt: "Kuzenbo theming runtime"
---

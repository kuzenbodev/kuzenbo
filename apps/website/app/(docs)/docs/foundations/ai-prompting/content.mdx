...
order: 3
surface: "utility"
seoTitle: "AI Prompting | Kuzenbo Docs"
seoDescription: "Use @kuzenbo/ai prompt utilities and session state safely in production UI flows."
ogImage: "/docs-og/foundations/ai-prompting"
ogImageAlt: "AI Prompting documentation"
---
...
```tsx
import { buildAiPrompt } from "@kuzenbo/ai";
...
import { AiWidget, buildAiPrompt, useAiSession } from "@kuzenbo/ai";

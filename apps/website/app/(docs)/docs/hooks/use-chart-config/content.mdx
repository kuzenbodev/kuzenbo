...
order: 7
surface: "hook"
seoTitle: "useChartConfig | Kuzenbo Docs"
seoDescription: "Read the current chart context from Chart.Provider or Chart.Root, including config, chart id, and color resolver helpers."
ogImage: "/docs-og/hooks/use-chart-config"
ogImageAlt: "useChartConfig documentation"
---
...
```tsx
import { useChartConfig } from "@kuzenbo/charts";
```
...
import { Chart, type ChartConfig, useChartConfig } from "@kuzenbo/charts";

...
order: 9
surface: "hook"
seoTitle: "useChartPortalTarget | Kuzenbo Docs"
seoDescription: "Create a portal mount target for chart overlays with a ref callback and nullable HTMLElement state."
ogImage: "/docs-og/hooks/use-chart-portal-target"
ogImageAlt: "useChartPortalTarget documentation"
---
...
```tsx
import { useChartPortalTarget } from "@kuzenbo/charts";
```
...
import { Chart, useChartPortalTarget } from "@kuzenbo/charts";
